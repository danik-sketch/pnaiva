...
VALUES
    ('Spring Boot Notebook', 'Курсач по разработке бэкенда', 1),
...
VALUES
    ('Настроить Hibernate', 'Разобраться с EntityGraph и Lazy Loading', false, '2026-03-15 10:00:00', 1),
    ('Написать DTO', 'Создать мапперы для всех сущностей', false, '2026-03-10 12:00:00', 1),
    ('Fix Waybar', 'Поправить отображение заряда батареи', true, '2026-03-01 15:00:00', 2);
...
INSERT INTO reminders (reminder_time, message, type, task_id)
VALUES
    ('2026-03-14 10:00:00', 'Повторить теорию по Hibernate', 'EMAIL', 1),
    ('2026-03-09 09:00:00', 'Проверить конфиг sway', 'PUSH', 3);