...
VALUES ('Дописать код', '', null, '2026-03-10 10:00:00', 1),
       ('Исправить отчет', 'Доделать обзор литературы и листиннг кода', null,
        '2026-03-15 12:00:00', 1),
       ('Fix Waybar', 'Поправить отображение заряда батареи', null, '2026-03-01 15:00:00', 2),
       ('Собрать билд', 'Проверить сборку проекта', '2026-03-05 18:00:00', '2026-03-04 10:30:00',
        2),
       ('Сделать эндпоинты', 'CRUD для заметок', null, '2026-03-20 09:00:00', 3),
       ('Добавить пагинацию', 'Pageable для списка заметок', '2026-03-21 12:00:00',
        '2026-03-19 17:15:00', 3),
...
VALUES ('2026-03-14 10:00:00', 'Повторить теорию по Hibernate', 1),
